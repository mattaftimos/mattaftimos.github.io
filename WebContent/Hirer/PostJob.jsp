...
<form class="form-vertical" action="/action_page.php">
     ...
     <select class="form-control" id="job-title" name="job-title">
                   ...
                   <option value = "SQL Data Analyst">SQL Data Analyst </option>
    ...
    <textarea class="form-control" id="job-description" name="job-description" rows="5" maxlength="199"></textarea>
  	</div>
  	   	<br>
  	 
  	 
  	  <div class=“form-group”>
     <label for="employment-time">Type of Job: </label>
     <select class="form-control" id="employment-time" name="employment-time">
     			   <option disabled selected> -- select a type of job -- </option>
     ...
     <label for="employment-pay">Pay Rate:</label>
     <select class="form-control" id="employment-pay" name="employment-pay" style="margin-right:50px"> 
     			   <option disabled selected> -- select Pay Rate -- </option>
                   <option value = "Hourly">Hourly</option>
                   <option value = "Annually">Yearly</option>
                   </select>
     	
   <label for="employment-amount">Pay Amount: </label>
   <input type="text" class="form-control" name="employment-amount">
