...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    <ul class="nav navbar-nav navbar-none" style="margin-left:30%;">
      ...
      <li><a href="hirerSearch.jsp" ><span class="glyphicon glyphicon-search" ></span> Hire Search</a></li>
      <li><a href="JobSearch.jsp" ><span class="glyphicon glyphicon-briefcase" ></span> Post Job</a></li>
    </ul>
  </div>
</nav>
</div>
	...
	<h1 style="text-align:center;">Job Search</h1>
	<hr>
...
<form class="form-vertical" action="/action_page.php">
     ...
     <label for="employment-status">Job Title: </label>
     <select class="form-control" id="employment-status">
     			   <option disabled selected> -- select a job title -- </option>
                   <option value = "1">Java Full Stack Developer</option>
                   <option value = "2">SQL Data Analyst </option>
