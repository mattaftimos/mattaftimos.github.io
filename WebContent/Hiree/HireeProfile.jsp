...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <div class="card-body">
    <h5 class="card-title" style="text-align:center;"><%=request.getParameter("role-status")%></h5>
  </div>
  <div class="card-header" style="background-color:#d4d4d4;">
   Location
  </div>
  ...
  <br>
	...
	<div class="card text-center" style="margin: 50px auto 50px auto; width:50%; border-raduis:12px;">
  <div class="card-header" style="background-color:#d4d4d4;">
   Background
  </div>
  <div class="card-body">
